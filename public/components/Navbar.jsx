...
const Navbar = ({setSearchDetails,currentPage, setCurrentPage, modal,setModal, bookmark, setBookmark,displayBookmark}) => {
   ...
   <div className='header'>
    ...
    <nav className='flex relative h-[80px]' >
        <ul className='flex w-[297.3px] justify-around'>
          ...
          <li onMouseOver={()=>setIsOpen(true)} onMouseOut={()=>setIsOpen(false)} className='flex cursor-pointer w-[145px] justify-center gap-4 items-center text-[1.5rem] text-[#615551] font-semibold '>
